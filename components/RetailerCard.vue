                ...
                <div class="sm:flex bg-gray-100/30 dark:bg-gray-500/30 hover:bg-gray-300/60 hover:dark:bg-gray-500/60 border-[1px] border-gray-300/70 dark:border-gray-500/70 backdrop-blur-[5px] rounded-3xl p-1 shadow-[0_0_10px_rgba(38,75,224,0.25)] transition-all duration-300 ease-out">
                    <div class="sm:w-[50%] px-3 py-1 flex flex-wrap items-center">
                        ...
                        <div class="flex flex-wrap items-center">
                            <!-- Stars -->
                            <div class="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-[#26C1E0] ml-1" viewBox="0 0 16 16">
                            ...
                            <!-- Price range -->
                            <div class="flex pl-2 dm-sans-bold text-[16px]">
                                <span class="text-[#26C1E0] underline">$9.99</span>
                                <span class="text-base-900 dark-font-outline">- $49.99</span>
                            </div>
                        </div>
                    </div>

                    <div class="sm:w-[50%] my-auto p-1">
                        <!-- Conditons -->
