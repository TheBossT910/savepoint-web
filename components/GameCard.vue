...
<template>
    <!-- Outer Product Card -->
    <div :id="`product-card-${props.id}`" class="bg-gray-100/30 dark:bg-gray-500/30 hover:bg-gray-300/60 hover:dark:bg-gray-500/60 border-[1px] border-gray-300/70 dark:border-gray-500/70 backdrop-blur-[5px] rounded-2xl p-[5px] shadow-sm dark:shadow-gray-400/60 transition-all duration-300 ease-out will-change-transform" @click="goToProduct">
        <div class="relative aspect-[2/3] rounded-2xl transition-all duration-300">
            ...
            <!-- Favorite badge -->
            <div class="flex items-center justify-center text-base-900 dark-font-outline absolute top-[16px] right-[16px] bg-[#EF4444]/70 border-[1px] border-[#F87171]/70 backdrop-blur-[5px] w-[22px] h-[22px] rounded-full">
