    ...
    <!-- <div> -->
        ...
        <div class="bg-gray-50 p-[10px] rounded-[12px] shadow-xl/25" @click="goToProduct">
            <div class="relative bg-gray-400 w-full aspect-[3/4] rounded-t-[12px]">
                ...
                <!-- Owned badge -->
                <div class="flex absolute top-[16px] left-[16px] bg-yellow-500/60 border-[1px] border-yellow-400/70 backdrop-blur-[5px] w-[58px] h-[22px] rounded-[12px] dm-sans-bold text-[12px]">
                    <div class="m-auto">
                        Owned
                    </div>
                </div>
                ...
                <!-- Favorite badge -->
                <div class="flex items-center justify-center absolute top-[16px] right-[16px] bg-red-500/60 border-[1px] border-red-400/70 backdrop-blur-[5px] w-[22px] h-[22px] rounded-full">
