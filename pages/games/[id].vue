<template>
    <div>
        <div class="relative pt-30 pb-10 px-10">
            ...
            <div class="relative grid grid-flow-col grid-rows-3 gap-10">
                <!-- Details -->
                <div class="row-span-3">
                    ...
                    <!-- Description -->
                    <div class="mt-5 w-full h-auto bg-gray-200/60 border-[1px] border-gray-100/70 backdrop-blur-[5px] rounded-[12px]">
                    ...
                    <!-- Platform badges-->
                    <div class="my-10 flex gap-x-[16px]">
                ...
                <!-- Card (on >=md) -->
                <div class="row-span-3 aspect-[3/4] hidden md:flex w-auto md:w-75 bg-gray-100/30 dark:bg-gray-500/30 hover:bg-gray-300/60 hover:dark:bg-gray-500/60 border-[1px] border-gray-300/70 dark:border-gray-500/70 backdrop-blur-[5px] rounded-[12px] p-1 shadow-sm dark:shadow-gray-400/60 transition-all duration-300 ease-out">
                    <div>
                        <img 
                        :src="coverImage"
                        class="w-full aspect-[3/4] object-cover rounded-[12px]"
                        >
                    </div>
                </div>
            </div>
