<template>
    <div>
        <div class="relative py-30 px-2 sm:px-5 md:px-20">
            ...
            <div class="flex flex-col w-full h-full">
                ...
                <!-- Reviews -->
                <div class="flex mt-2 ml-1 w-100 h-[20px] opacity-0 transition-opacity duration-700 ease-out" :class="loaded ? 'opacity-100' : ''" :style="{ transitionDelay: `200ms` }">
                    <!-- Metacritic -->
 ...
 -->
                <!-- Description -->
                <div class="mt-5 w-full md:w-[50%] xl:w-[35%] bg-[#10A4DA]/70 border-[1px] border-[#26C1E0]/70 backdrop-blur-[5px] rounded-xl opacity-0 transition-opacity duration-700 ease-out" :class="loaded ? 'opacity-100' : ''" :style="{ transitionDelay: `400ms` }">
                ...
                <!-- Buttons -->
                <div class="mt-2 flex flex-wrap gap-2 opacity-0 transition-opacity duration-700 ease-out" :class="loaded ? 'opacity-100' : ''" :style="{ transitionDelay: `600ms` }">
                    <!-- Buy -->
                ...
                <!-- Platform badges-->
                <div class="mt-10 flex gap-x-[16px] opacity-0 transition-opacity duration-700 ease-out" :class="loaded ? 'opacity-100' : ''" :style="{ transitionDelay: `800ms` }">
